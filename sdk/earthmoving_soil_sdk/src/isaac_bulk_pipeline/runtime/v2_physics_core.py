...
class EarthmovingPhysicsCore:
    ...
    def __init__(
        ...
        *,
        ...
        self.dump_operator = TerrainDumpOperator(mobile=mobile_solver)
    ...
    def _step_gpu(
        ...
        *,
        ...
        physical_yield_present = avalanche_transition.unstable_cell_count > 0
        ...
        timings["gpu_large_avalanche"] = (perf_counter() - start) * 1_000.0
